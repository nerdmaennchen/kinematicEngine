...
KinematicNodeWheel::KinematicNodeWheel(KinematicNode *parent,
		std::string name,
		double maxForce,
		RPM maxSpeed,
		...
		Degree alphaY,
		Degree alphaZ)
	: KinematicNodeRotation(parent, name, maxForce, maxSpeed, translationX, translationY, translationZ, alphaX, alphaY, alphaZ)
	, m_motor(nullptr)
{
...
dBodyID KinematicNodeWheel::attachToODE(PhysicsEnvironment *environment, dSpaceID visualSpaceID, dSpaceID collisionSpaceID, arma::mat44 parentsCoordinateFrame)
{
	...
	m_motor = new ODEWheelMotor(m_motors[0], m_rotationJoint, environment, this, m_maxForce, m_maxSpeed);
